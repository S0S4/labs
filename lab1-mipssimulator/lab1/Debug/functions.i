...
#pragma external_header(push)
#line 1 "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.40.33807\\include\\stdint.h"
...
#line 97 "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.40.33807\\include\\stdint.h"
    ...
    #line 112 "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.40.33807\\include\\stdint.h"
#line 113 "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.40.33807\\include\\stdint.h"
...
#line 20 "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.40.33807\\include\\stdbool.h"
...
void addiu() { 
    ...
    int8_t rs = (curr_ins & 0x03E00000) >> 21;
    int8_t rt = (curr_ins & 0x001F0000) >> 16;
    uint16_t imm = (curr_ins & 0x0000FFFF);
...
void beq() { 
    ...
    int8_t rs = curr_ins && 0x03E00000;
    int8_t rt = curr_ins && 0x001F0000;
...
void addi() { 
    ...
    int32_t curr_ins = mem_read_32(CURRENT_STATE.PC);
    int32_t imm = (int32_t)(curr_ins & 0x0000FFFF); 
    int8_t rs = (curr_ins & 0x03E00000);
    int8_t rt = (curr_ins & 0x001F0000);

    int32_t sum = imm + rs;

    if ((sum & 0x80000000) != (sum & 0x40000000)){ 
...
void sltiu() { 
    int32_t curr_ins = mem_read_32(CURRENT_STATE.PC);
    uint32_t imm = (int32_t)(curr_ins & 0x0000FFFF);
    int8_t rs = (curr_ins & 0x03E00000);
    int8_t rt = (curr_ins & 0x001F0000);
...
void lui() { 
    int32_t curr_ins = mem_read_32(CURRENT_STATE.PC);
    int32_t imm = (int32_t)(curr_ins & 0x0000FFFF) << 16;
    int8_t rt = (curr_ins & 0x001F0000);
...
void lb() { 
    int32_t curr_ins = mem_read_32(CURRENT_STATE.PC);
    int32_t imm = (int32_t)(curr_ins & 0x0000FFFF);
    int8_t base = (curr_ins & 0x03E00000);
    int8_t rt = (curr_ins & 0x001F0000);
    ...
    int32_t virt_addr_val = (int32_t) (mem_read_32(virt_addr) && 0xFF); 
...
void lbu() { 
    ...
    uint32_t virt_addr_val = (uint32_t)(mem_read_32(virt_addr) && 0xFF); 
    NEXT_STATE.REGS[rt] = virt_addr_val;
}
...
void bltz() { 
    int32_t curr_ins = mem_read_32(CURRENT_STATE.PC);
    int32_t offset = (int32_t)(curr_ins & 0x0000FFFF);
    int8_t rs = (curr_ins & 0x03E00000);
...
void sll() { 
    ...
    int32_t curr_ins = mem_read_32(CURRENT_STATE.PC);
    int32_t rt = curr_ins & 0x001F0000;
    int32_t rd = curr_ins & 0x00007C00;
...
void sllv() {
    ...
    int32_t rs = curr_ins & 0x03E00000;
    int32_t rt = curr_ins & 0x001F0000;
    int32_t rd = curr_ins & 0x00007C00;
